...
// Instance paths are dot-joined for simple names ("game.ReplicatedStorage.Mod")
// and bracket-quoted for names a dot-split would corrupt: dots, spaces, quotes,
// leading digits, Luau keywords → game.ServerScriptService["init.spec"]. Both
// forms round-trip through parseInstancePath.
