...
const TOOL_HANDLERS: Record<string, ToolHandler> = {
  ...
  get_project_structure: (tools, body) => tools.getProjectStructure(body.instancePath ?? body.path, body.maxDepth, body.scriptsOnly, body.knownHash),
  ...
  get_script_source: (tools, body) => tools.getScriptSource(body.instancePath, body.startLine, body.endLine, body.knownHash),
  get_script_outline: (tools, body) => tools.getScriptOutline(body.instancePath, body.knownHash),
  set_script_source: (tools, body) => tools.setScriptSource(body.instancePath, body.source),
  edit_script_lines: (tools, body) => tools.editScriptLines(body.instancePath, body.old_string, body.new_string, body.validateAfter),
  ...
  get_attributes: (tools, body) => tools.getAttributes(body.instancePath, body.attributeName, body.knownHash),
